...
public class CurrencyConversionV3
{
    public static void main(String [ ] args)
    {
        ...
        System.out.print("Please enter the peso>usd exchange rate:  ");
        double pesoExchangeRate = in.nextDouble();
        System.out.print("Please enter the yen>usd exchange rate:  ");
        double yenExchangeRate = in.nextDouble();
        System.out.print("Please enter the euro>usd exchange rate:  ");
		...
		double fundsRemaining2 = (double) budget2 % costItem2; //(double) budget2 - ((double) costItem2 * (double) totalItem2);  	//how much of the budget is left
